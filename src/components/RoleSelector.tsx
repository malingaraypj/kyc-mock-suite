...
const RoleSelector = ({ onSelectRole }: RoleSelectorProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/20 to-primary/5 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="flex items-center justify-center min-h-screen p-6 relative z-10">
        <div className="w-full max-w-6xl">
          ...
          <div className="mb-8 animate-fade-in" style={{ animationDelay: "200ms" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {roles.map((role, index) => (
                <Card
                  key={role.id}
                  className="group cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-elevated border-2 hover:border-primary/50 backdrop-blur-sm bg-card/80 animate-fade-in"
          ...
          {/* Features */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 animate-fade-in" style={{ animationDelay: "700ms" }}>
